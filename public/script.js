...
// //
// const index = fetchHtmlFiles('index.html');
// body.push(sort("/", index.toString()));
// body.push(sort("/index.html", index.toString()));
// const helium = fetchHtmlFiles('helium.html');
// body.push(sort("/helium.html", helium.toString()));
// const hydrogen = fetchHtmlFiles('hydrogen.html');
// body.push(sort("/hydrogen.html", hydrogen.toString()));
// const styles = fetchHtmlFiles(`css/styles.css`);
// body.push(sort("/styles.html", styles.toString()));
// const four0Four = fetchHtmlFiles('404.html');
...
//         if (err) throw err;
//           result = fs.readFileSync(`${parsedChunk.elementName}.html`);
//           body.push(sort(`/${parsedChunk.elementName.toLowerCase()}.html`, result.toString()));
//           aTag.innerHTML = `${parsedChunk.elementName}`;
